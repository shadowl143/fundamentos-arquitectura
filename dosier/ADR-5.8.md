# ADR 5.8 — Despliegue, Contenedores (Docker) y Servidores de Producción (Gunicorn/Uvicorn)
**Contexto:** Despliegue, Contenedores (Docker) y Servidores de Producción (Gunicorn/Uvicorn)
**Criterio:** Generar un docker file valido
